...
if [ "$pack_type" = "EXT" ];then
    ...
    for pname in ${super_list};do
        ...
        mkfs.erofs -zlz4hc,9 -T 1230768000 --mount-point=/${pname} --fs-config-file=build/portrom/images/config/${pname}_fs_config --file-contexts=build/portrom/images/config/${pname}_file_contexts build/portrom/images/${pname}.img build/portrom/images/${pname}
